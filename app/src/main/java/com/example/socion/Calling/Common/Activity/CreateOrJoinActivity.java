package com.example.socion.Calling.Common.Activity;
...
import com.example.socion.Calling.Common.fragment.CreateMeetingFragment;
import com.example.socion.Calling.Common.fragment.CreateOrJoinFragment;
import com.example.socion.Calling.Common.fragment.JoinMeetingFragment;
...
public class CreateOrJoinActivity extends AppCompatActivity {
    ...
    String name, meeting,meetingType;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("Socion Calling");

        setSupportActionBar(toolbar);

        name = getIntent().getStringExtra("name");
        meeting = getIntent().getStringExtra("meeting");
        meetingType = getIntent().getStringExtra("meetingMode");
    ...
    public void CreateMeetingFragment() {
        setActionBar();
        //region Passing Some Variable
        Bundle bundle = new Bundle();
        bundle.putString("name", name);
        bundle.putString("meeting", meeting);
        bundle.putString("meetingMode", meetingType);
        CreateMeetingFragment fragInfo = new CreateMeetingFragment();
        fragInfo.setArguments(bundle);
        //endregion
        final FragmentTransaction ft = getFragmentManager().beginTransaction();
        ft.replace(R.id.fragContainer, fragInfo, "NameFragment");
    ...
    public void joinMeetingFragment() {
        ...
        bundle.putString("meeting", meeting);
        bundle.putString("meetingMode", meetingType);
        JoinMeetingFragment fragInfo = new JoinMeetingFragment();
        fragInfo.setArguments(bundle);
        //endregion

        final FragmentTransaction ft = getFragmentManager().beginTransaction();
        ft.replace(R.id.fragContainer, fragInfo, "JoinMeetingFragment");
        //ft.addToBackStack("CreateOrJoinFragment");
        ft.commit();
    }
